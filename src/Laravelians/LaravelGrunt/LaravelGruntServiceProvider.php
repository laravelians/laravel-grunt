...
class LaravelGruntServiceProvider extends ServiceProvider {
	 ...
	 * 
	 * @return  Laravelians\LaravelGrunt\GruntSetupCommand
	 */
	 ...
	 * 
	 * @return  Laravelians\LaravelGrunt\GruntBuildCommand
	 */
	 ...
	 * 
	 * @return  Laravelians\LaravelGrunt\GruntWatchCommand
	 */
	...
	{
		$this->package('laravelians/laravel-grunt');
	}
